...
- **Notebooks:** All the code behind this article — from bigram to full transformer — is in my [learn-gpt notebooks](https://github.com/vallari24/learn-gpt/tree/main/notebooks). Follow along, run the cells, break things.
